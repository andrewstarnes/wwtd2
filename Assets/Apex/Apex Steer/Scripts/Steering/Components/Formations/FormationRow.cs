...
namespace Apex.Steering
{
    ...
    /// <summary>
    /// This formation returns position in a straight line to the left and to the right of the model unit.
    /// </summary>
    public class FormationRow : IFormation
    {
        private float _formationSpacing = 1.5f;

        /// <summary>
        /// Initializes a new instance of the <see cref="FormationRow"/> class.
        /// </summary>
        /// <param name="formationSpacing">The formation spacing.</param>
        public FormationRow(float formationSpacing)
        {
