...
namespace Lean
{
	...
	public class LeanTouch : MonoBehaviour
	{
		...
		public static float dampen = 10f;
		...
		public static void MoveObject(Transform transform, Vector2 deltaPosition, Camera camera = null)
		{
			if (transform != null)
			{
				if (deltaPosition.x != 0.0f || deltaPosition.y != 0.0f)
				{
					...
					{
						if(transform==Camera.main.transform) {
							Vector3 newPos = MoveCameraObject(transform.position,deltaPosition,Camera.main);
		...
		public static Vector3 MoveCameraObject(Vector3 worldPosition, Vector2 deltaPosition, Camera camera = null)
		{
			worldPosition += new Vector3(deltaPosition.x*-1/dampen,0f,deltaPosition.y*-1/dampen);
